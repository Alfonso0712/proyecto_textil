...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    width: 130px;          /* Ancho fijo para todos */
    text-align: center;    /* Centrar texto */
    padding: .3rem 0;      /* Ajuste de padding vertical */
    border-radius: 20px;
    font-size: .65rem;
    font-weight: 700;
    color: #fff;
    ...
    gap: 5px;
    width: 105px;          /* Ancho fijo para botones de acción */
    height: 32px;          /* Altura fija para que coincidan a/button */
    border: none;
    border-radius: 6px;
    cursor: pointer;
    font-size: .75rem;
    ...
    transition: all .15s;
    vertical-align: middle; /* Alineación con el texto de la celda */
}

/* Ajuste específico para que el icono no se mueva */
.btn-editar { background: #ffc107; color: #1a1a2e; }
.btn-deact  { background: #e74c3c; color: #fff; }
.btn-actv   { background: #27ae60; color: #fff; }

/* Importante: Ajuste del formulario en la tabla */
td form {
    display: inline-block;
    margin: 0;
    padding: 0;
