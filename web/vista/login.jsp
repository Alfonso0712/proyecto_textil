...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .alerta-horario .icono { font-size: 1.3rem; flex-shrink: 0; margin-top: 1px; }
    .alerta-horario strong { display: block; font-size: .88rem; margin-bottom: 2px; color: #5a2d00; }
    .alerta-error {
      background: #fee2e2;
...
<body>
  ...
  <div class="form-right">
    <div class="form-container">
      ...
      <%-- Mensaje de horario: viene del LoginServlet cuando el usuario intenta fuera de horario --%>
      <%
      ...
      <%-- Mensaje de horario: se muestra cuando el SesionFiltro cierra sesión por hora --%>
      <% if ("1".equals(request.getParameter("errorHorario"))) { %>
        <div class="alerta-error" style="border-color:#e67e22; background:#fff8f0; color:#7a3c00;">
          ...
          <span>&#9200; Acceso fuera de horario laboral.<br>
          El sistema está disponible de <strong>7:00 AM a 5:00 PM</strong>.<br>
          Comunícate con el administrador si necesitas acceso fuera de este horario.</span>
        </div>
      <% } %>
