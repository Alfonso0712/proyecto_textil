...
public class TelaDAO {
    ...
    public boolean actualizarTelaCompleta(int idTela, int idOt, String origen, String proveedor,
                                            String tipoTejido, String color, int numRollos,
                                            BigDecimal pesoGuia, BigDecimal pesoReal,
                                            Tela.EstadoCalidad estado, String observaciones,
                                            boolean requiereReposo, Integer idCatalogo) {
          String sql = """
              UPDATE telas SET
                  id_ot = ?,
                  origen = ?,
          ...
          try (Connection cn = ConexionDB.obtenerConexion();
              ...
              ps.setString(4, tipoTejido);
              ps.setString(5, color);
              ps.setInt(6, numRollos);
              ps.setBigDecimal(7, pesoGuia);
              ps.setBigDecimal(8, pesoReal);
              ps.setString(9, estado.name());
              ps.setString(10, observaciones);
              ps.setBoolean(11, requiereReposo);
              if (idCatalogo != null && idCatalogo > 0) {
                  ps.setInt(12, idCatalogo);
              } else {
              ...
              throw new RuntimeException("Error al actualizar tela completamente: " + e.getMessage(), e);
          }
      }
