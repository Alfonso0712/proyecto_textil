...
public class Tela {
    ...
    private int idCatalogoTela;
    // Campo para guardar el tiempo que viene del catálogo
    private int tiempoReposoCatalogo;
    ...
    private String nombreCatalogoTela;  // para mostrar en vistas
    ...
    public int    getIdCatalogoTela()           { return idCatalogoTela; }
    public void   setIdCatalogoTela(int v)      { this.idCatalogoTela = v; }
    
    public String getNombreCatalogoTela()       { return nombreCatalogoTela; }
    public void   setNombreCatalogoTela(String v){ this.nombreCatalogoTela = v; }
    
    public int getTiempoReposoCatalogo() { return tiempoReposoCatalogo; }
    public void setTiempoReposoCatalogo(int tiempoReposoCatalogo) { this.tiempoReposoCatalogo = tiempoReposoCatalogo; }
    /**
